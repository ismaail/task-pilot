<div class="w-[600px] py-1">
	<div class="flex px-2 justify-between items-center">
		<h2 class="font-semibold text-text">@lang('Edit Task')</h2>
	...
	<form class="my-2 px-2 pt-2 space-y-4 border-t border-gray-300" wire:submit.prevent="update">
		<div>
		...
		<div class="flex justify-end">
			<button type="submit" class="btn disabled:bg-gray-300">
				<span wire:loading.class="hidden">@lang('Update')</span>
