...
<div class="flex flex-col w-full px-4 pb-4">
	...
	<div class="flex flex-row flex-wrap w-full grow items-start content-start justify-start mt-4 gap-4">
		@foreach($boards as $board)
			<div class="flex items-start basis-50 min-h-40 shrink-0 w-72 p-2 space-y-2 rounded border border-gray-400/40 bg-gray-300 text-text font-semibold">
